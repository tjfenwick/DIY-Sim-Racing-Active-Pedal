...
It is recommended to use the PCB design provided [here](..\..\Wiring\Gerber_PCB_ActivePedalEsp32S2miniAds1256V1 copy.zip). 
...
# Software
## Dependencies
Before flashing the ESP32 via Arduino IDE, the dependencies need to be installed. They are located in the [libs dir](\libs)
